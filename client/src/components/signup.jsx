...
function Signup() {
    ...
    const  registeruser = (e)=>{
        e.preventDefault();
        axios.post("/api/register",{name,alias,email,password,confirmPassword},{withCredentials: true})
        .then(res=>{
          console.log(res)
          navigate('/ideas')
        })
  ...
  return (
    <div  className="relative flex flex-col mt-28 text-gray-700 bg-transparent shadow-none rounded-xl bg-clip-border">
  <h4  className="block font-sans text-2xl antialiased font-semibold
   leading-snug tracking-normal text-blue-gray-900">
    Sign Up
  </h4>
  <p  className="block mt-1 font-sans text-base
   antialiased font-normal leading-relaxed text-gray-700">
    Nice to meet you! Enter your details to register.
  </p>

  <form onSubmit={registeruser} className="max-w-screen-lg mt-8 mb-2 w-80 sm:w-96">
    <div  className="flex flex-col gap-6 mb-1">
      ...
      <div  className="relative h-11 w-full min-w-[200px]">
        ...
        <label
           className="before:content[' '] after:content[' '] pointer-events-none absolute left-0 -top-1.5
           flex h-full w-full select-none !overflow-visible truncate text-[11px] font-normal leading-tight
            text-gray-500 transition-all before:pointer-events-none before:mt-[6.5px] before:mr-1 before:box-border
             before:block before:h-1.5 before:w-2.5 before:rounded-tl-md 
          before:border-t before:border-l before:border-blue-gray-200 before:transition-all before:content-none
           ...
           after:content-none peer-placeholder-shown:text-sm peer-placeholder-shown:leading-[4.1] peer-placeholder-shown:text-blue-gray-500 
           peer-placeholder-shown:before:border-transparent peer-placeholder-shown:after:border-transparent peer-focus:text-[11px]
            peer-focus:leading-tight peer-focus:text-gray-900 peer-focus:before:border-t-2 peer-focus:before:border-l-2
        ...
        <label
          ...
          before:border-t before:border-l before:border-blue-gray-200 before:transition-all before:content-none
           ...
           peer-disabled:before:border-transparent peer-disabled:after:border-transparent
            ...
            {
                errs.alias?
                <p className='text-[#ff1100]'>{errs.alias.message}</p>
                :
                null
            }
      </div>
